...
WebUI.verifyElementPresent(findTestObject('AmazonLogin/Page_Amazon Iniciar sesin/input_Olvidaste tu contrasea_password'), 
    0)

WebUI.verifyElementClickable(findTestObject('AmazonLogin/Page_Amazon Iniciar sesin/input_Olvidaste tu contrasea_password'))

WebUI.setText(findTestObject('AmazonLogin/Page_Amazon Iniciar sesin/input_Olvidaste tu contrasea_password'), GlobalVariable.PASSWORD)
